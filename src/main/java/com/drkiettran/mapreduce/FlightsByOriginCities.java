 ...
 */
public class FlightsByOriginCities {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        job.setJarByClass(FlightsByOriginCities.class);
        job.setJobName("FlightsByOriginCities");

        TextInputFormat.addInputPath(job, new Path(inputPath));
        job.setInputFormatClass(TextInputFormat.class);

        job.setMapperClass(FlightsByOriginCitiesMapper.class);
        job.setReducerClass(FlightsByOriginCitiesReducer.class);
